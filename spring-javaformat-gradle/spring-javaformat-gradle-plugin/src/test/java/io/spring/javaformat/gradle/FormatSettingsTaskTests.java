...
/**
 * Tests for {@link FormatSettingsTask}.
 *
 * @author Phillip Webb
 */
public class FormatSettingsTaskTests {
	...
	public void checkOk() throws IOException {
		BuildResult result = this.gradleBuild.source("src/test/resources/check-ok-wide")
				.build("formatSettings");
		assertThat(result.task(":formatSettings").getOutcome())
				.isEqualTo(TaskOutcome.SUCCESS);
		assertThat(result.getOutput())
				.contains("io.spring.javaformat.setting.style=WIDE");
	}
