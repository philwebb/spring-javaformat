 ...
 */
public class WidescreenFormatterTests extends AbstractFormatterTests {

	public WidescreenFormatterTests(File source, File expected) {
	...
	public static Collection<Object[]> files() {
		return AbstractFormatterTests.files("WidescreenFormatterTests-expected");
	}
